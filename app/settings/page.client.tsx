...
} from 'lucide-react'; // Using lucide-react for icons, assuming it's installed or can be added
...
export default function SettingsPageClient() {
  ...
  return (
    ...
    <div className="flex flex-col min-h-screen bg-background text-foreground">
      {/* Main Content Area */}
      <div className="flex-1 p-4 md:p-6 overflow-y-auto"> {/* Added flex-1 and padding */}
        {/* Header Section */}
      ...
      {/* Logout Button - Added as a common settings action */}
       <Card className="mb-6 p-0">
         <Button variant="ghost" className="w-full justify-start p-3 text-red-500 flex items-center gap-3">
